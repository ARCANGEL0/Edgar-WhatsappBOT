...
const smsWelcome = () => { return `*╭┈⊰* @subject *⊰┈ ✦*\n*┊✒️ Bem vindo.\n${pickRandom(["Bem-vindo à obscura morada das palavras, onde cada saudação é um eco sombrio. 🕯️🐈‍⬛",
  ...
  "Olá, visitante da penumbra, onde as frases revelam segredos e os cumprimentos são sinistros.🐈‍⬛🕸️",
  ...
  "Oi, forasteiro das narrativas enigmáticas, que mistérios deseja desvelar hoje?🕯️🪦",
...
const smsToxic2 = () => { return `É PROIBIDO SER TÓXICO`}
const smsToxic3 = () => { return `*AVISO*\n⚠️`}
const smsToxic4 = () => { return `😭 EU SINTO MUITO`}
const smsToxic5 = () => { return `☢️ DESATIVAR ANTITOXIC`}
const smsToxic6 = () => { return `Repeti meus avusos mas desconsideraste o meu presságio🥀`}
...
//afk-_afk.js
const smsAfkM1 = () => { return `*É 𝐚𝐧𝐮𝐧𝐜𝐢𝐚𝐝𝐨 𝐨 𝐫𝐞𝐭𝐨𝐫𝐧𝐨 𝐝𝐨 𝐯𝐢𝐚𝐣𝐚𝐧𝐭𝐞, 𝐩𝐨𝐛𝐫𝐞 𝐚𝐥𝐦𝐚 𝐪𝐮𝐞 𝐫𝐞𝐭𝐨𝐦𝐚 𝐬𝐮𝐚 𝐩𝐫𝐞𝐬𝐞𝐧𝐜𝐚 𝐚 𝐞𝐬𝐭𝐞 𝐯𝐚𝐥𝐞 𝐬𝐨𝐦𝐛𝐫𝐢𝐨 𝐝𝐞 𝐭𝐨𝐫𝐦𝐞𝐧𝐭𝐚 🪦🕯️*`} 
const smsAfkM2 = () => { return `\n*𝐀 𝐜𝐚𝐮𝐬𝐚 𝐟𝐢𝐧𝐚𝐥 𝐩𝐚𝐫𝐚 𝐚𝐮𝐬𝐞𝐧𝐜𝐢𝐚 𝐟𝐨𝐢*\n`} 
const smsAfkM3 = () => { return `⏳ *𝐓𝐞𝐦𝐩𝐨 𝐎𝐜𝐢𝐨𝐬𝐨:*`} 
const smsAfkM4 = () => { return `*𝐍ã𝐨 𝐩𝐞𝐫𝐭𝐮𝐫𝐛𝐞 𝐞𝐬𝐭𝐚 𝐚𝐥𝐦𝐚 𝐩𝐞𝐧𝐚𝐝𝐚, 𝐩𝐨𝐢𝐬 𝐞𝐥𝐚 𝐬𝐞 𝐞𝐧𝐜𝐨𝐧𝐭𝐫𝐚 𝐚𝐮𝐬𝐞𝐧𝐭𝐞, 𝐯𝐚𝐠𝐚𝐧𝐝𝐨 𝐩𝐞𝐥𝐚 𝐩𝐞𝐧𝐮𝐦𝐛𝐫𝐚 🥀*\n`} 
const smsAfkM5 = () => { return `*𝐀 𝐜𝐚𝐮𝐬𝐚 𝐟𝐢𝐧𝐚𝐥 𝐩𝐚𝐫𝐚 𝐚𝐮𝐬𝐞𝐧𝐜𝐢𝐚 𝐟𝐨𝐢 :*\n`} 
const smsAfkM6 = () => { return `*𝐀 𝐜𝐚𝐮𝐬𝐚 𝐟𝐢𝐧𝐚𝐥 𝐩𝐚𝐫𝐚 𝐚𝐮𝐬𝐞𝐧𝐜𝐢𝐚 𝐟𝐨𝐢 :\n𝙼𝚘𝚝𝚒𝚟𝚘 𝚍𝚎𝚜𝚌𝚘𝚗𝚑𝚎𝚌𝚒𝚍𝚘 𝚝𝚊𝚒𝚜 𝚌𝚘𝚖𝚘 𝚊𝚜 𝚜𝚘𝚖𝚋𝚛𝚊𝚜*`} 
...
const smsAfkM1A = () => { return `*🕯️💀𝐍𝐚𝐨 𝐜𝐡𝐚𝐦𝐞*`} 
const smsAfkM1B = () => { return `*「 𝐈𝐫𝐚 𝐬𝐞 𝐚𝐮𝐬𝐞𝐧𝐭𝐚𝐫 𝐛𝐫𝐞𝐯𝐞𝐦𝐞𝐧𝐭𝐞 𝐩𝐚𝐫𝐚 𝐟𝐢𝐧𝐬 𝐩𝐚𝐫𝐭𝐢𝐜𝐮𝐥𝐚𝐫𝐞𝐬」*\n\n*𝐂𝐚𝐮𝐬𝐚:*`} 
