...
const smsLista1 = () => { return `🌟 INFORMAÇÕES DO POE 🌟`}
...
const smsWelcome = () => { return `*╭┈⊰* @subject *⊰┈ ✦*\n*┊✒️ Bem vindo.\n${pickRandom(["Bem-vindo à obscura morada das palavras, onde cada saudação é um eco sombrio.",
...
const smsBye = () => { return `*╭┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈⊰*\n┊ @user\n┊ *SAIU DO GRUPO..\n${pickRandom(["Na sombra da noite, meu adeus ecoa como um sussurro gélido.",
  "Parto com as sombras, onde o adeus se entrelaça ao manto da eternidade.",
  "Ao crepúsculo, deixo-te com o eco melancólico de meu até logo.",
  "Na penumbra, minha despedida dança como a última nota de uma triste melodia.",
  "No silêncio do crepitar das velas, sigo adiante, deixando-te com um derradeiro adeus."])}*🐦‍⬛ \n*╰┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈⊰*`}
...
//grupo-setbye.js
const smsSetB = () => { }}{ `${lenguajeGB['smsAvisoEG']()}*A DESPEDIDA DO GRUPO ESTÁ CONFIGURADA*`}
