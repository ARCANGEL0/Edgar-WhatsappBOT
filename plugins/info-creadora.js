...
await conn.sendFile(m.chat, pp, 'gata.mp4', cat, fkontak, contextInfo: { externalAdReply: { title: '𝓔𝓭𝓰𝓪𝓻 𝓑𝓞𝓣 🐈‍⬛  🐈', body: '𝓔𝓭𝓰𝓪𝓻 𝓑𝓞𝓣 🐈‍⬛ ', sourceUrl: `https://instagram.com/henryy.xn`, thumbnail: imagen2}})
}
